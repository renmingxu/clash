...
#
# Build:
#   - git clone -b dev https://github.com/renmingxu/clash
#   - cd clash
...
go build -ldflags "-X \"github.com/renmingxu/clash/constant.Version=$VERSION\" -X \"github.com/renmingxu/clash/constant.BuildTime=$BUILDTIME\" -w -s" \
